 ...
 * (during {@code NerolandCoreCommon.init()}) and attached to the mod bus group by
 * the loader entry point via {@link #registerAll(BusGroup)}.
 *
 * <p>Registered via {@code META-INF/services/
 * za.co.neroland.nerolandcore.registry.RegistrationProvider$Factory}.
 */
