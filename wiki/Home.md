...
> **Status:** V1 foundation complete — version `1.1.0`. Core is a **library, not a content mod**:
...
> Tank, Item Store); the gameplay — machines, generators, planets — lives in the mods that depend on it.
...
- Storage blocks — passive endpoints Core ships: [Battery](Battery.md), [Fluid Tank](Fluid-Tank.md),
  [Gas Tank](Gas-Tank.md), [Item Store](Item-Store.md), and the [Creative Source Blocks](Creative-Source-Blocks.md).
